...
const onboardingStorageKey = "portfolio-onboarding-seen";
          ...
          <div className={`mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3 md:px-6 ${isRtl ? "flex-row-reverse" : ""}`}>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="rounded-xl border border-cyan-500/50 px-3 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-500/10 dark:text-cyan-300"
              >
                {t("onboardingGuide.actions.open")}
              </button>
              <LanguageSwitcher />
              <ModeSwitcher />
              <ThemeToggle />

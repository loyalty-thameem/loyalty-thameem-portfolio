...
const ModeSwitcher = () => {
  ...
  return (
    <label data-tour="mode" className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-2 py-1 text-xs text-slate-700 backdrop-blur dark:text-slate-200">
